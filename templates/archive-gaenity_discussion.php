<?php
/**
 * Template for Discussion Archive (Forum Page) - FIXED VERSION
 * 
...
function gaenity_get_industries() {
    return array(
        'Retail & e-commerce',
        'Food & Beverage',
        'Manufacturing',
...
// Helper function to get challenges
function gaenity_get_challenges() {
    return array(
        'Financial Controls',
        'Operations',
        'Marketing & Sales',
            ...
            <form class="gaenity-filter-form" method="get">
                ...
                <div class="gaenity-filter-group">
                    ...
                    <select name="region" class="gaenity-filter-select">
                        ...
                        <?php
                        foreach ( gaenity_get_regions() as $region ) {
                ...
                <div class="gaenity-filter-group">
                    ...
                    <select name="industry" class="gaenity-filter-select">
                        ...
                        <?php
                        foreach ( gaenity_get_industries() as $industry ) {
                ...
                <div class="gaenity-filter-group">
                    ...
                    <select name="topic" class="gaenity-filter-select">
                        ...
                        <?php
                        foreach ( gaenity_get_challenges() as $challenge ) {
                        ...
                        <div class="gaenity-discussion-card">
                            ...
                            <div class="gaenity-discussion-actions">
                                <?php if ( $is_logged_in ) : ?>
                                    ...
                                    <!-- <button class="gaenity-action-btn" onclick="<?//php the_permalink(); ?>"> -->
                                        <a href="<?php the_permalink(); ?> "class="gaenity-action-btn">
                                        👍 <?php esc_html_e( 'View & Like', 'gaenity-community' ); ?>
                                        </a>
                                    <!-- </button> -->
                                <?php else : ?>
            ...
            <aside class="gaenity-forum-sidebar">
                ...
                <div class="gaenity-sidebar-box">
                    ...
                    <ul class="gaenity-spotlight-list">
                        <?php
                        $regions = array_slice( gaenity_get_regions(), 0, 5 );
                ...
                <div class="gaenity-sidebar-box">
                    ...
                    <ul class="gaenity-spotlight-list">
                        <?php
                        $industries = array_slice( gaenity_get_industries(), 0, 5 );
                ...
                <div class="gaenity-sidebar-box">
                    ...
                    <ul class="gaenity-spotlight-list">
                        <?php
                        $challenges = array_slice( gaenity_get_challenges(), 0, 5 );
